...
def test_fetch_entities():
    ...
    class Product:
        ...
        @classmethod
        def resolve_reference(cls: "Product", upc) -> "Product":
...
def test_info_param_in_resolve_reference():
    ...
    class Product:
        ...
        @classmethod
        def resolve_reference(cls: "Product", info, upc) -> "Product":
...
async def test_can_use_async_resolve_reference():
    ...
    class Product:
        ...
        @classmethod
        async def resolve_reference(cls: "Product", upc: str) -> "Product":
            return Product(upc=upc)
